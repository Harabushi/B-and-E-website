...
import { faFacebook, faYoutube, faInstagram, faBandcamp } from '@fortawesome/free-brands-svg-icons';
        ...
        <div className="container text-center text-md-start mt-5">
          <div className="row mt-3">
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p><i className="fas fa-phone me-3"></i><a href="tel:612-644-3966">612 644 3966</a></p>
            </div>
          </div>
        </div>
      </section>
